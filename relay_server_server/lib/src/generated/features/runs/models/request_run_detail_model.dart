...
import '../../../features/runs/models/request_run_response_snapshot_model.dart'
    as _i4;
import 'package:relay_server_server/src/generated/protocol.dart' as _i5;

abstract class RequestRunDetailModel
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'RequestRunDetailModel',
      'run': run.toJsonForProtocol(),
      if (requestSnapshot != null)
        'requestSnapshot': requestSnapshot?.toJsonForProtocol(),
      if (responseSnapshot != null)
        'responseSnapshot': responseSnapshot?.toJsonForProtocol(),
    };
  }
